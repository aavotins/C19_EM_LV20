...
Preparation of table with observed, model predicted, difference and excess values
...
total_2020_csv=total_2020_csv %>% 
  ...
  summarize(AllCause_diff=round(AllCause_observed-fit_total_tp_c,0),
            ...
            AllCause_excess=ifelse(round(AllCause_observed-fit_total_tp_c,0)>0,
                                   round(AllCause_observed-fit_total_tp_c,0),0),
            AllCause_excess_max=ifelse(round(AllCause_observed-AllCause_PImin,0)>0,
                                       round(AllCause_observed-AllCause_PImin,0),0),
            AllCause_excess_min=ifelse(round(AllCause_observed-AllCause_PImax,0)>0,
                                       round(AllCause_observed-AllCause_PImax,0),0)) %>%
  ungroup()
...
I00I99_2020_csv=I00I99_2020_csv %>%
  ...
  summarize(Circulatory_diff=round(Circulatory_observed-Circulatory_fitted,0),
            ...
            Circulatory_excess=ifelse(round(Circulatory_observed-Circulatory_fitted,0)>0,
                                      round(Circulatory_observed-Circulatory_fitted,0),0),
            Circulatory_excess_PImin=ifelse(round(Circulatory_observed-Circulatory_PImax,0)>0,
                                            round(Circulatory_observed-Circulatory_PImax,0),0),
            Circulatory_excess_PImax=ifelse(round(Circulatory_observed-Circulatory_PImin,0)>0,
                                            round(Circulatory_observed-Circulatory_PImin,0),0)) %>% 
ungroup()
...
C00C97_2020_csv=C00C97_2020_csv %>% 
  ...
  summarize(Oncology_diff=round(Oncology_observed-Oncology_fitted,0),
            ...
            Oncology_excess=ifelse(round(Oncology_observed-Oncology_fitted,0)>0,
                                   round(Oncology_observed-Oncology_fitted,0),0),
            Oncology_excess_max=ifelse(round(Oncology_observed-Oncology_PImin,0)>0,
                                       round(Oncology_observed-Oncology_PImin,0),0),
            Oncology_excess_min=ifelse(round(Oncology_observed-Oncology_PImax,0)>0,
                                       round(Oncology_observed-Oncology_PImax,0),0)) %>% 
ungroup()
...
E10E14_2020_csv=E10E14_2020_csv %>% 
  ...
  summarize(Diabetes_diff=round(Diabetes_mellitus-Diabetes_fitted,0),
            ...
            Diabetes_excess=ifelse(round(Diabetes_mellitus-Diabetes_fitted,0)>0,
                                   round(Diabetes_mellitus-Diabetes_fitted,0),0),
            Diabetes_excess_max=ifelse(round(Diabetes_mellitus-Diabetes_PImin,0)>0,
                                       round(Diabetes_mellitus-Diabetes_PImin,0),0),
            Diabetes_excess_min=ifelse(round(Diabetes_mellitus-Diabetes_PImax,0)>0,
                                       round(Diabetes_mellitus-Diabetes_PImax,0),0)) %>% 
ungroup()
...
J42J47_2020_csv=J42J47_2020_csv %>% 
  ...
  summarize(CLRd_diff=round(CLRd_observed-CLRd_fitted,0),
            ...
            CLRd_excess=ifelse(round(CLRd_observed-CLRd_fitted,0)>0,
                                   round(CLRd_observed-CLRd_fitted,0),0),
            CLRd_excess_max=ifelse(round(CLRd_observed-CLRd_PImin,0)>0,
                                       round(CLRd_observed-CLRd_PImin,0),0),
            CLRd_excess_min=ifelse(round(CLRd_observed-CLRd_PImax,0)>0,
                                       round(CLRd_observed-CLRd_PImax,0),0)) %>% 
ungroup()
